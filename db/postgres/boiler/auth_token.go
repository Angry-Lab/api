...
func (q authTokenQuery) One(ctx context.Context, exec boil.ContextExecutor) (*AuthToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for auth_token")
	}
...
func (q authTokenQuery) All(ctx context.Context, exec boil.ContextExecutor) (AuthTokenSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to AuthToken slice")
	}
...
func (q authTokenQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count auth_token rows")
	}
...
func (q authTokenQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if auth_token exists")
	}
...
func FindAuthToken(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*AuthToken, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from auth_token")
	}
...
func (o *AuthToken) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no auth_token provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into auth_token")
	}
...
func (o *AuthToken) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update auth_token, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update auth_token row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for auth_token")
	}
...
func (q authTokenQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for auth_token")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for auth_token")
	}
...
func (o AuthTokenSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in authToken slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all authToken")
	}
	return rowsAff, nil
}
...
func (o *AuthToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no auth_token provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiler: unable to upsert auth_token, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert auth_token")
	}
...
func (o *AuthToken) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no AuthToken provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from auth_token")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for auth_token")
	}
...
func (q authTokenQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no authTokenQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from auth_token")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for auth_token")
	}
...
func (o AuthTokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from authToken slice")
	}
...
func (o *AuthTokenSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in AuthTokenSlice")
	}
...
func AuthTokenExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if auth_token exists")
	}
